...
class EmergencyContactSearchController extends GetxController {
  ...
  onSearchTextChanged(String text) {
    ...
    _debouncer.debounce(() {
      _firestoreServices.searchEmergencyContactUser(text).then((value) {
...
class EmergencyContactSearchBindings extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut(() => EmergencyContactSearchController());
  }
}