...
import 'controllers/emergency_contact_searchController.dart';

class EmergencyContactSearchView extends GetView<EmergencyContactSearchController> {
  const EmergencyContactSearchView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Search Contacts",
          style: AppTextStyles.kPrimaryS7W2.copyWith(color: Colors.white),
        ),
      ),
      body: Padding(
          ...
          children: [
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: "Search Emergency Contact",
            ...
            Obx(() => MyWidgetsAnimator(
                  ...
                  holdingWidget: () => const Center(child: Text("Search your Emergency contacts")),
