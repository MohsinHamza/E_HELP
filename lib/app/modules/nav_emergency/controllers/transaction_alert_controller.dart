...
class TransactionAlertController extends GetxController
  ...
  onInit() async{
    ...
    Functions.requestForLocationPermission().then((value){
      if(value){
        _updateUserLocation();
      }
    });
  ...
  void startLocationStream() {
    try {
      ...
      locationServices.location.getLocation().then((value) =>
          FirebaseFirestoreService.find.updateLatLngAsStream(
              alertType: alertType.value,
              lat: value.latitude ?? _lat,
              lng: value.longitude ?? _lng,
              isStreamActive: false));
      locationSubscription =
          locationServices.getStreamedLocation.handleError((onError) {
